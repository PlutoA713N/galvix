...
export default function NewsLetterSection() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32 md:w-[70%] md:m-auto rounded-2xl md:flex md:justify-center">

      <div >
       
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none ">
         
          <div className="max-w-auto lg:max-w-auto py-[0.5%] px-[14%] ">

            <h2 className="text-3xl max-w-[100%] font-bold tracking-tight text-white sm:text-4xl">Focus on your business. We’ll take care of sales tax</h2>

            <p className="mt-4 mb-8 text-lg leading-8 text-gray-300  md:max-w-[85%] md:text-center">
